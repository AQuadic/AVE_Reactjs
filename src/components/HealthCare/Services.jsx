        ...
        <section className="container my-8">
            <div className='grid lg:grid-cols-4 grid-cols-2 gap-6'>
                {services.map((service) => (
                    ...
                    >
                        <img src={service.image} className='w-full h-full' alt={service.title} />
                        <div className='flex w-16 h-16 bg-[#FFFFFF] rounded-full mt-[-10%] items-center justify-center'>
                            {service.icon}
                        </div>
                        <h1 className='text-[#1E1E1E] font-bold lg:text-[32px] text-center leading-[40px] text-sm lg:mt-8 mt-1'>
                            {service.title}
                        </h1>
                    </div>
                ))}
