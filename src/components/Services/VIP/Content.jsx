        ...
        <section className='container mx-auto flex flex-wrap items-center justify-between md:my-[88px] mt-5'>
            <div className='px-3 md:px-0'>
                <div className='flex items-center gap-4'>
                    ...
                    <h1 className="font-bold md:text-[40px] text-base text-[#1E1E1E]">تجهيز سيارات <span className="text-[#B1060D]">كبار الشخصيات </span>بأنواعها</h1>
                </div>
                <h3 className="md:mt-6 mt-2 font-normal md:text-xl text-base text-[#1E1E1E] leading-8">بدأنا في تجهيز سيارات كبار الشخصيات لتطوير المجال وتجهيز أنواع مختلفة من كبار الشخصيات لتصبح حجر الزاوية لكل من يأتي من بعدنا، وتشمل هذه الأنواع من سيارات الإسعاف:</h3>
