    ...
    return (
        <section className='container mx-auto flex flex-wrap items-center justify-between md:my-[88px] mt-5'>
            <div className='px-3 md:px-0'>
                ...
                <h3 className="mt-6 font-normal text-xl text-[#1E1E1E] leading-8">بدأنا في تجهيز سيارات كبار الشخصيات لتطوير المجال وتجهيز أنواع مختلفة من كبار الشخصيات لتصبح حجر الزاوية لكل من يأتي من بعدنا، وتشمل هذه الأنواع من سيارات الإسعاف:</h3>
