        ...
        <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto md:px-4">
          ...
          >
            ...
            <div className="flex flex-col gap-5 font-normal text-lg rtl:space-x-reverse">
              <NavLink
                to="/"
                className="block py-1 px-4 md:p-0 text-xs  transform ${isVip ? 'hover:text-vipColor': 'hover:text-[#D82022]'} hover:text-[#D82022] hover:underline transition-all duration-300"
                aria-current="page"
              >
                {t("home")}
              </NavLink>
              ...
              >
                <img src={arrow} className="w-3 h-3" alt="Arrow" />
                <NavLink className="block px-2 md:p-0  text-sm transform ${isVip ? 'hover:text-vipColor': 'hover:text-[#D82022]'} hover:text-[#D82022] hover:underline transition-all duration-300">
                  {t("services")}
                </NavLink>
                {isOpen && (
                  <ul className="absolute left-2 top-6 mt-2 bg-white border border-gray-100 rounded-md w-60 z-10">
                    <li className="px-4 py-2 hover:bg-gray-200">
                      <NavLink to="/vip" className="block text-sm">
                        {t("vip")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-gray-200">
                      <NavLink to="/ambEquipmenet" className="block text-sm">
                        {t("ambEquip")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-gray-200">
                      <NavLink to="/service3" className="block text-sm">
                        {t("lab")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-gray-200">
                    ...
                    <li className="px-4 py-2 hover:bg-gray-200">
                      <NavLink to="/icecream" className="block">
                        {t("icecream")}
                      </NavLink>
                    </li>
                  </ul>
              ...
              >
                ...
                {isOpen && (
                  <ul className="absolute left-[-50px] top-6 mt-2 bg-white border border-gray-100 rounded-md w-60 z-10">
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/vip" className="block">
                        {t("vip")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/ambEquipmenet" className="block">
                        {t("ambEquip")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/lab" className="block">
                        {t("lab")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/clinics" className="block">
                        {t("clinics")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/service3" className="block">
                        {t("disabilities")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                    ...
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/office" className="block">
                        {t("office")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
                      <NavLink to="/coffee" className="block">
                        {t("cafe")}
                      </NavLink>
                    </li>
                    <li className="px-4 py-2 hover:bg-[#D82022]">
