  ...
  const renderServicesDropdown = (isMobile = true) => (
    ...
    >
      {servicesDropdown.map((service, index) => (
        <li
          key={index}
          className={`relative px-4 py-2 ${isVip ? "hover:bg-vipColor" : "hover:bg-[#D82022] hover:text-white"
            }`}
      ...
      <nav className="container relative z-20">
        <div className="flex flex-wrap items-center justify-between mx-auto max-w-screen-2xl md:px-4">
          ...
          <div className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <NavLink to="/">
              <img
                ...
                className="w-[200px] h-auto max-h-[80px] p-2 object-contain"
                alt="Logo"
              />
            </NavLink>
          </div>
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul className="flex flex-col gap-5 p-4 text-lg font-normal md:p-0 rtl:space-x-reverse md:flex-row">
              <li>
                <NavLink
                  to="/"
