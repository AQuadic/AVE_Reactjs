    ...
    return (
        <div className="relative overflow-hidden animate__animated animate__fadeIn">
            ...
            <div className="absolute md:top-1/2 top-10 md:left-1/2 transform md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col items-center">
                <h1 className="text-[#FAFAFA] md:text-[56px] text-center">{title}</h1>
                <p className="lg:w-[590px] text-[rgb(250,250,250)] md:text-2xl text-sm font-normal text-center mx-auto md:mt-6">{description}</p>
                {button && (
                    <button className="md:w-[215px] w-[120px] h-10 md:h-14 bg-[#D82022] text-white rounded-sm md:font-bold md:text-lg text-sm mt-4 md:mt-8">
                        {button}
                    </button>
                )}
            </div>
