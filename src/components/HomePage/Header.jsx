        ...
        <header className="container md:h-80">
            <div className='flex md:flex-row flex-col justify-between'>
                <section className='animate__animated animate__bounceInRight md:my-[23px] md:order-1 order-2 mt-56 mb-12 md:mb-0 md:mt-14 text-center md:text-start'>
                    <h1 className="md:font-normal font-bold lg:text-[56px] text-xl text-[#1E1E1E]">{t('arabic')} <span className="text-[#B1060D]"> {t('Vehicle')} </span>{t('Equipment')}</h1>
                    <p className="lg:w-[590px] w-[330px] text-[#505050] lg:text-2xl text-sm md:font-normal font-bold md:mt-6 mt-2">{t('headTitle')}</p>
